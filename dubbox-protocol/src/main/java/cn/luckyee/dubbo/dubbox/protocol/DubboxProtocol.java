 ...
 */
public class DubboxProtocol extends AbstractProtocol {

    public static final String NAME = "META-INF/dubbo";

    public static final int DEFAULT_PORT = 20880;
    private static final String IS_CALLBACK_SERVICE_INVOKE = "_isCallBackServiceInvoke";
    private static DubboxProtocol INSTANCE;
    ...
    public DubboxProtocol() {
        INSTANCE = this;
    }

    public static DubboxProtocol getDubboProtocol() {
        if (INSTANCE == null) {
            // load
            ExtensionLoader.getExtensionLoader(Protocol.class).getExtension(DubboxProtocol.NAME);
        }
    ...
    Invoker<?> getInvoker(Channel channel, Invocation inv) throws RemotingException {
        ...
        String serviceKey = AbstractProtocol.serviceKey(
                port,
                path,
    ...
    public <T> Exporter<T> export(Invoker<T> invoker) throws RpcException {
        ...
        // export service.
        String key = AbstractProtocol.serviceKey(url);
        DubboExporter<T> exporter = new DubboExporter<T>(invoker, key, exporterMap);
        exporterMap.put(key, exporter);

        //export an stub service for dispatching event
        Boolean isStubSupportEvent = url.getParameter(STUB_EVENT_KEY, Constants.DEFAULT_STUB_EVENT);
    ...
    private ProtocolServer createServer(URL url) {
        url = URLBuilder.from(url)
                ...
                .addParameter(CODEC_KEY, DubboxCodec.NAME)
                .build();
        String str = url.getParameter(SERVER_KEY, Constants.DEFAULT_REMOTING_SERVER);
    ...
    private ExchangeClient initClient(URL url) {
        ...
        url = url.addParameter(CODEC_KEY, DubboxCodec.NAME);
        // enable heartbeat by default
