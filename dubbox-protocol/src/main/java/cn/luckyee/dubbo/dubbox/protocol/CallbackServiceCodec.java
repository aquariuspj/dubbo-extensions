...
class CallbackServiceCodec {
    ...
    private static final DubboxProtocol PROTOCOL = DubboxProtocol.getDubboProtocol();
    ...
    private static String exportOrUnexportCallbackService(Channel channel, URL url, Class clazz, Object inst, Boolean export) throws IOException {
        ...
        URL exportUrl = new URL(DubboxProtocol.NAME, channel.getLocalAddress().getAddress().getHostAddress(), channel.getLocalAddress().getPort(), clazz.getName() + "." + instid, tmpMap);
    ...
    public static Object decodeInvocationArgument(Channel channel, RpcInvocation inv, Class<?>[] pts, int paraIndex, Object inObject) throws IOException {
        ...
        URL url = null;
        try {
            url = DubboxProtocol.getDubboProtocol().getInvoker(channel, inv).getUrl();
